...
/**
 * JUnit test for check criterion "outlines".
...
public class OutlinesTest {
	...
	@Test
	public void testOutlines_TrueWord(){
		String pdfFile = pathToPDFs+"Word_ueberschriften_Acrobat.pdf";
		PDDocument document;
		try {
			document = PDDocument.load(pdfFile);
			boolean actual = Check.hasOutlines(document);
			document.close();
	...
	@Test
	public void testOutlines_FalseWord(){
	...
	@Test
	public void testOutlines_TrueLatex(){
	...
	@Test
	public void testOutlines_FalseLatex(){
